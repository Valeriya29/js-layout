...
const createArticle = () => {
  ...
  const text = createElement(
    'p',
    'article__text',
    'База знань - це база даних, що вміщує правила виводу та інформацію про людський досвід та знання в деякій предметній області. В самонавчаючихся системах база знань також вміщує інформацію, яка є результатом вірішення попередніх задач.',
  )
